    ...
    <div className="container zapchasti">
      ...
      <div className="top-section">
        <div className="image-block">
          <img
            src="images/2.png"
            alt="Распределительная камера"
          />
        </div>
        <div className="text-block">
          <h2 className="mg-2 md-9 mg-7">Распределительная камера</h2>
          <p className="drobemet-description">
            Распределительная камера - это элемент, определяющий угол вылета дроби из турбины. Распределительную камеру можно назвать прицелом дробемета, так как от её правильного положения зависит скорость очистки детали. Средний срок службы распределительной камеры - 1000 моточасов (при условии корректной эксплуатации оборудования). 
          </p>
        </div>
      </div>
