    ...
    <div className="container zapchasti">
      ...
      <div className="top-section">
        ...
        <div className="text-block">
          <h2 className="mg-2 md-9 mg-7">Торцевая броня турбины</h2>
          <p className="drobemet-description">
            Торцевая броня защищает корпус турбины, питатель и электродвигатель от прямого попадания дроби. Данный элемент не является быстроизнашиваемым, так как практически не имеет контакта с дробью и может прослужить более 2500 моточасов.
          </p>
        </div>
      </div>
...
export default TortsevayaBronya;