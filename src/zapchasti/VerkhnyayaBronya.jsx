    ...
    <div className="container zapchasti">
      ...
      <div className="top-section">
        <div className="image-block">
          <img
            src="images/5.png"
            alt="Верхняя броня турбины"
          />
        </div>
        <div className="text-block">
          <h2 className="mg-2 md-9 mg-7">Верхняя броня турбины</h2>
          <p className="drobemet-description">
            Верхняя броня защищает крышку корпуса турбины от прямого попадания дроби. Данный элемент является быстроизнашиваемым в случае несвоевременной настройки факела вылета дроби, а также износа распределительной камеры и лопастей. Средний срок службы - 1500 моточасов (при условии корректной эксплуатации оборудования). 
          </p>
        </div>
      </div>
...
export default VerkhnyayaBronya;