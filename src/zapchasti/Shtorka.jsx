    ...
    <div className="container zapchasti">
      ...
      <div className="top-section">
        <div className="image-block">
          <img
            src="images/12.png"
            alt="Шторка для дробемета"
          />
        </div>
        <div className="text-block">
          <h2 className="mg-2 md-9 mg-7">Шторка для дробемета</h2>
          <p className="drobemet-description">
            Дробеметная шторка предназначена для предотвращения вылета дроби из рабочей камеры. Для увеличения её срока службы, сердцевина выполняется из пружинистой стали, благодаря чему шторка выдерживает большое количество циклов сгибания без изменения формы. 
          </p>
        </div>
      </div>
