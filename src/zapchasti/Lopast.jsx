    ...
    <div className="container zapchasti">
      ...
      <div className="top-section">
        ...
        <div className="text-block">
          <h2 className="mg-2 md-9 mg-7">Лопасть</h2>
          <p className="drobemet-description">
            Дробеметная лопатка (лопасть) предназначена для выброса дроби из турбины на обрабатываемую деталь..Как результат, она подвержена интенсивному износу дробью. Средний срок службы дробеметной лопасти - 700 моточасов (при условии корректной эксплуатации оборудования). 
          </p>
        </div>
      </div>
