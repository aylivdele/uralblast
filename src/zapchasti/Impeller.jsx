    ...
    <div className="container zapchasti">
      ...
      <div className="top-section">
        ...
        <div className="text-block">
          <h2 className="mg-2 md-9 mg-7">Импеллер</h2>
          <p className="drobemet-description">
            Импеллер или ускоритель предназначен для дозирования потока дроби, выбрасываемой на лопасть. Импеллер придает первоначальное ускорение дроби. Средний срок службы импеллера 1000 моточасов (при условии корректной эксплуатации оборудования). 
          </p>
        </div>
      </div>
